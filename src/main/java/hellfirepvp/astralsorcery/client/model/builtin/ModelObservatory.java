 ...
 * Date: 16.02.2020 / 10:31
 */
public class ModelObservatory extends CustomModel {

    private static final Supplier<AbstractRenderableTexture> TEX_OBSERVATORY =
            AssetLibrary.loadReference(AssetLoader.TextureLocation.BLOCKS, "entity", "observatory");

    private RendererModel base;
    private RendererModel tube;
    private RendererModel seat;
    private RendererModel base1;
    private RendererModel base2;
    private RendererModel base3;
    private RendererModel base4;
    private RendererModel base5;
    private RendererModel base6;
    private RendererModel base7;
    private RendererModel base8;

    private RendererModel seat1;
    private RendererModel seat2;
    private RendererModel seat3;
    private RendererModel seat4;
    private RendererModel seat5;
    private RendererModel seat6;
    private RendererModel seat7;
    private RendererModel seat8;
    private RendererModel seat9;
    private RendererModel seat10;
    private RendererModel seat11;
    private RendererModel seat12;
    private RendererModel seat13;
    private RendererModel seat14;

    private RendererModel tube1;
    private RendererModel tube2;
    private RendererModel tube3;
    private RendererModel tube4;
    private RendererModel tube5;
    private RendererModel tube6;
    private RendererModel tube7;
    private RendererModel tube8;
    private RendererModel tube9;
    private RendererModel tube10;
    private RendererModel tube11;
    private RendererModel tube12;
    private RendererModel tube13;
    private RendererModel tube14;
    private RendererModel tube15;
    ...
    public void render(float iYaw, float iPitch, int destroyStage) {
        this.bindDamaged(TEX_OBSERVATORY.get(), destroyStage);
