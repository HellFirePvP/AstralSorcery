...
public class RegistryTextures {
    ...
    public static void loadTextures() {
        ...
        TEX_DISCIDIA_BACKGROUND   = loadTexture(CONSTELLATION, "discidia_background");
        TEX_ARMARA_BACKGROUND   = loadTexture(CONSTELLATION, "armara_background");
        TEX_VICIO_BACKGROUND   = loadTexture(CONSTELLATION, "vicio_background");
        TEX_AEVITAS_BACKGROUND   = loadTexture(CONSTELLATION, "aevitas_background");
        TEX_EVORSIO_BACKGROUND   = loadTexture(CONSTELLATION, "evorsio_background");
        TEX_LUCERNA_BACKGROUND   = loadTexture(CONSTELLATION, "lucerna_background");
        TEX_MINERALIS_BACKGROUND   = loadTexture(CONSTELLATION, "mineralis_background");
        TEX_HOROLOGIUM_BACKGROUND   = loadTexture(CONSTELLATION, "horologium_background");
        TEX_OCTANS_BACKGROUND   = loadTexture(CONSTELLATION, "octans_background");
        TEX_BOOTES_BACKGROUND   = loadTexture(CONSTELLATION, "bootes_background");
        TEX_FORNAX_BACKGROUND   = loadTexture(CONSTELLATION, "fornax_background");
        TEX_PELOTRIO_BACKGROUND   = loadTexture(CONSTELLATION, "pelotrio_background");
        TEX_GELU_BACKGROUND   = loadTexture(CONSTELLATION, "gelu_background");
        TEX_ULTERIA_BACKGROUND   = loadTexture(CONSTELLATION, "ulteria_background");
        TEX_ALCARA_BACKGROUND   = loadTexture(CONSTELLATION, "alcara_background");
        TEX_VORUX_BACKGROUND   = loadTexture(CONSTELLATION, "vorux_background");
