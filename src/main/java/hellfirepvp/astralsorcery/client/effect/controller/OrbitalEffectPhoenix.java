 ...
 * Class: OrbitalEffectPhoenix
 * Created by HellFirePvP
 * Date: 13.11.2016 / 15:18
 */
public class OrbitalEffectPhoenix implements OrbitalEffectController.OrbitPersistence, OrbitalEffectController.OrbitPointEffect, OrbitalEffectController.OrbitTickModifier {
    ...
    public void doPointTickEffect(OrbitalEffectController ctrl, Vector3 pos) {
        ...
        if(rand.nextInt(2) == 0) {
            ...
            p.offset((rand.nextFloat() * 0.01F) * (rand.nextBoolean() ? 1 : -1),
                     ...
                     (rand.nextFloat() * 0.01F) * (rand.nextBoolean() ? 1 : -1));
            p.setColor(CEffectPhoenix.PHOENIX_COLOR);
