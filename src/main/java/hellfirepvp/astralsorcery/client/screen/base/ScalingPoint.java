...
public class ScalingPoint {
    ...
    public static ScalingPoint copy(ScalingPoint otherPoint) {
        ScalingPoint point = new ScalingPoint();
        point.posX = otherPoint.posX;
        point.posY = otherPoint.posY;
        point.scaledX = otherPoint.scaledX;
        point.scaledY = otherPoint.scaledY;
        return point;
    }
