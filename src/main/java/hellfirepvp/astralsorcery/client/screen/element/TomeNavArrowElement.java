 ...
 * Class: TomeNavArrowElement
 * Created by HellFirePvP
 * Date: 07.09.2026 / 10:00
 */
public class TomeNavArrowElement extends AbstractWidget {

    private final boolean pointsRight;
    private final AbstractRenderTexture texture;
    private final Runnable onClick;

    public TomeNavArrowElement(int x, int y, boolean pointsRight, Runnable onClick) {
        this(x, y, pointsRight, TexturesAS.SCREEN_TOME_NAV_ARROWS, onClick);
    }

    public TomeNavArrowElement(int x, int y, boolean pointsRight, AbstractRenderTexture texture, Runnable onClick) {
        super(x - 10, y - 5, 20, 10, GameNarrator.NO_TITLE);
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        float u = this.pointsRight ? 0 : 0.5F;
