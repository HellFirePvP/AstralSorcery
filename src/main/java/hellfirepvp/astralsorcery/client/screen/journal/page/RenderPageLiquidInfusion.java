...
public class RenderPageLiquidInfusion extends RenderPageRecipeTemplate {
    ...
    public void render(float offsetX, float offsetY, float pTicks, float zLevel, float mouseX, float mouseY) {
        ...
        tas = tas != null ? tas : MissingTextureSprite.func_217790_a();

        Tessellator.getInstance().getBuffer().begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX_COLOR);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 1, 0);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 2, 0);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 3, 0);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 1, 4);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 2, 4);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 3, 4);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 0, 1);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 0, 2);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 0, 3);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 4, 1);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 4, 2);
        this.renderLiquidInput(offsetX, offsetY, zLevel, tas, 4, 3);
        Tessellator.getInstance().draw();
    }

    private void renderLiquidInput(float offsetX, float offsetY, float zLevel, TextureAtlasSprite tas, int x, int y) {
        float liquidX = offsetX + 28;
        float liquidY = offsetY + 76;
        RenderingGuiUtils.rect(liquidX + x * 25.15F, liquidY + y * 25.15F, zLevel, 22.3F, 22.3F)
                .tex(tas)
                .draw();
    }
