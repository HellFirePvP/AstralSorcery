...
public class PerkDamageOnKill extends ConstellationPerk {
    ...
    private static float dmgMultiplier = 6F;
    ...
    public void loadFromConfig(Configuration cfg) {
        dmgMultiplier = cfg.getFloat(getKey() + "DamageIncrease", getConfigurationSection(), dmgMultiplier, 1F, 20F, "Sets the damage multiplier that is applied to entity damaged after knocked back if the player has this perk.");
