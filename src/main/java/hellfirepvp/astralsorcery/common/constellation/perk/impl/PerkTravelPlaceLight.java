...
public class PerkTravelPlaceLight extends ConstellationPerk {
    ...
    private static int chanceToSpawnLight = 400;
    ...
    public void loadFromConfig(Configuration cfg) {
        chanceToSpawnLight = cfg.getInt(getKey() + "ChanceForLight", getConfigurationSection(), 400, 20, 4000, "Sets the chance (Random.nextInt(chance) == 0) to try to see if a light close to the player might be spawned");
    }
}
