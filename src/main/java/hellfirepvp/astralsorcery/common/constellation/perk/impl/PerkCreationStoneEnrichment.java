...
public class PerkCreationStoneEnrichment extends ConstellationPerk {
    ...
    private static int chanceToEnrich = 200;
    ...
    public void loadFromConfig(Configuration cfg) {
        ...
        chanceToEnrich = cfg.getInt(getKey() + "GenChance", getConfigurationSection(), 200, 10, 2000, "Sets the chance (Random.nextInt(chance) == 0) to try to see if a random stone next to the player should get turned into an ore");
    }
