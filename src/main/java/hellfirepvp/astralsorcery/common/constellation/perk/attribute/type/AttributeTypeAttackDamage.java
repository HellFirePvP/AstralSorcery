...
public class AttributeTypeAttackDamage extends PerkAttributeType {
    ...
    private static final UUID ATTACK_DAMAGE_BOOST_ADD_MULTIPLY_ID = UUID.fromString("020E0DFB-87AE-4653-9556-831010FF91A1");
    private static final UUID ATTACK_DAMAGE_BOOST_STACK_MULTIPLY_ID = UUID.fromString("020E0DFB-87AE-4653-9556-831010FF91A2");
