 ...
 */
public class FeatureSmallShrineStructure extends ConfiguredStructureFeature {
    ...
    public static class Start extends ConfiguredStructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            ...
            if (genPos != null) {
                SmallShrineStructure shrine = new SmallShrineStructure(templateManagerIn, genPos);
