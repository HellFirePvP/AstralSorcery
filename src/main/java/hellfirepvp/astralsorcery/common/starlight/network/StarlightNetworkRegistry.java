...
public class StarlightNetworkRegistry {
    ...
    public static void registerEndpoint(Block block) {
        registerEndpoint(block, -1);
    }

    public static void registerEndpoint(Block block, int meta) {
        validEndpoints.put(block, meta);
    }
