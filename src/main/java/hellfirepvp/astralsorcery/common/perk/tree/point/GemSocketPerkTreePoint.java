...
import hellfirepvp.astralsorcery.client.screen.tome.perk.render.GemSocketPerkRenderer;
 ...
 * Class: GemSocketPerkTreePoint
 * Created by HellFirePvP
 * Date: 07.09.2026 / 10:00
 */
public class GemSocketPerkTreePoint<T extends GemSocketPerk> extends PerkTreePoint<T> {

    public GemSocketPerkTreePoint(FloatPoint offset, T perk) {
        this(offset, perk, 1F);
    }

    protected GemSocketPerkTreePoint(FloatPoint offset, T perk, float renderScale) {
    ...
    public Supplier<PerkRenderer<?, T>> getRenderer() {
        return () -> MiscUtil.cast(GemSocketPerkRenderer.GEM_SOCKET);
    }
}
