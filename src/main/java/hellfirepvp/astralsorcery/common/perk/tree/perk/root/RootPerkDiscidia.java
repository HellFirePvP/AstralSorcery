 ...
 * Class: RootPerkDiscidia
 * Created by HellFirePvP
 * Date: 07.09.2026 / 10:00
 */
public class RootPerkDiscidia extends RootPerk<AbstractPerk.Data> {

    public static final MapCodec<RootPerkDiscidia> CODEC = RecordCodecBuilder.mapCodec(inst -> perkRootFields(inst).apply(inst, RootPerkDiscidia::new));
    public static final PerkType<RootPerkDiscidia> TYPE =
            PerkType.of(RootPerkDiscidia.CODEC, PerkDataTypesAS.DEFAULT_DATA, RootPerkDiscidia::new);
    ...
    protected DiminishingMultiplier createMultiplier() {
        return DiminishingMultiplier.of()
                .multiplierReGainTime(120)
                .multiplierReGainRate(0.075F)
                .multiplierLossRate(0.025F)
                .minMultiplier(0.15F)
                .build();
    }
