 ...
 */
public class ContainerAltarRadiance extends ContainerAltar {

    public ContainerAltarRadiance(@Nullable MenuType<?> menuType, TileAltar tile, Inventory playerInv, int containerId) {
    ...
    public ContainerAltarRadiance(@Nullable MenuType<?> menuType, TileAltar tile, Inventory playerInv, int containerId, RegistryFriendlyByteBuf byteBuf) {
