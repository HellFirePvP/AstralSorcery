 ...
 * Class: AttunedRockCrystalItem
 * Created by HellFirePvP
 * Date: 07.09.2026 / 10:00
 */
public class AttunedRockCrystalItem extends RockCrystalItem {

    public AttunedRockCrystalItem() {}

    protected AttunedRockCrystalItem(CrystalAttributesComponent emptyComponent) {
