...
import static hellfire.astralSorcery.common.lib.LibConstants.MODID;

/**
 * This class is part of the Astral Sorcery Mod
 * <p/>
 * Created by HellFirePvP @ 24.01.2016 20:52
 */
public class ItemNBTHelper {
    ...
    public static NBTTagCompound getPersistentData(NBTTagCompound base) {
        ...
        if(hasPersistentData(base)) {
            compound = base.getCompoundTag(MODID);
        } else {
            compound = new NBTTagCompound();
            base.setTag(MODID, compound);
        }
        return compound;
    }
    ...
    public static boolean hasPersistentData(NBTTagCompound base) {
        NBTBase modData = base.getTag(MODID);
