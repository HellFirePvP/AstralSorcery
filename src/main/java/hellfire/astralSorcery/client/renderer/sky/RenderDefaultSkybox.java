 ...
 * <p/>
 * Created by HellFirePvP @ 25.01.2016 12:01
 */
public class RenderDefaultSkybox extends IRenderHandler {
    ...
    public static void setupDefaultSkybox() {
        ...
        setupStars(worldrenderer);
        setupSky1(worldrenderer);
        setupSky2(worldrenderer);
    }

    private static void setupSky2(WorldRenderer worldrenderer) {
        ...
        if (OpenGlHelper.useVbo()) {
            ...
            setupSkyVertices(worldrenderer, -16.0F, true);
    ...
    private static void setupSky1(WorldRenderer worldrenderer) {
        ...
        if (OpenGlHelper.useVbo()) {
            ...
            setupSkyVertices(worldrenderer, 16.0F, false);
            worldrenderer.finishDrawing();
            worldrenderer.reset();
    ...
    private static void setupStars(WorldRenderer worldrenderer) {
        ...
        if (OpenGlHelper.useVbo()) {
            ...
            setupStarVertices(worldrenderer);
            worldrenderer.finishDrawing();
            worldrenderer.reset();
    ...
    private static void setupSkyVertices(WorldRenderer worldRendererIn, float y, boolean invert) {
        //int i = 64;
        //int j = 6;
        ...
        for (int k = -384; k <= 384; k += 64) {
            for (int l = -384; l <= 384; l += 64) {
                ...
                worldRendererIn.pos((double)f, (double)y, (double)l).endVertex();
                worldRendererIn.pos((double)f1, (double)y, (double)l).endVertex();
                worldRendererIn.pos((double)f1, (double)y, (double)(l + 64)).endVertex();
                worldRendererIn.pos((double)f, (double)y, (double)(l + 64)).endVertex();
            }
        }
    }

    private static void setupStarVertices(WorldRenderer worldRenderer) {
    ...
    private static void renderDefaultSkybox(float partialTicks) {
        ...
        double d0 = Minecraft.getMinecraft().thePlayer.getPositionEyes(partialTicks).yCoord - Minecraft.getMinecraft().theWorld.getHorizon();
